...

{
    ...
    "sequence": 1,
    "author": "BROWSEINFO",
    "website": 'https://www.browseinfo.com/demo-request?app=product_bundle_pack&version=18&edition=Community',
    "version": '18.0.0.0',
    "depends": ['sale','product','stock','sale_management','purchase','sale_stock'],
    "data": [
        'security/ir.model.access.csv',
        'wizard/product_bundle_wizard_view.xml',
        'wizard/explore_bundle_wizard.xml',
        'wizard/purchase_explore_bundle_wizard.xml',
        'wizard/purchase_product_bundle_wizard_view.xml',
    ...
    "application": True,
    "auto_install": False,
    "live_test_url": 'https://www.browseinfo.com/demo-request?app=product_bundle_pack&version=18&edition=Community',
