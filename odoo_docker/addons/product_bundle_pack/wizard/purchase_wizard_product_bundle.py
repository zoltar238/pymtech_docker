...
class purchase_wizard_product_bundle(models.TransientModel):
    _name = 'purchase.product.bundle.wizard'
    _description = 'Purchase Product Bundle Wizard'
    ...
    def button_bundle_purchase(self):
        ...
        for pack in self:
            ...
            if pack.product_id == pack.product_id and pack.product_id.uom_id == pack.product_id.uom_id:
